...
const { getSearchStatsFn, getMostWantedFn } = require('./db/searchStats');
...
// Search STATS
app.get('/search-stats', getSearchStatsFn({ config, logger }));
app.get('/stats/most-wanted', getMostWantedFn({ config, logger }));
